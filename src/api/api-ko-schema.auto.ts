...
export type Mutation = {
  ...
  createAgeRanges?: Maybe<AgeRangesMutationResult>;
...
export type MutationCreateAgeRangesArgs = {
  input: Array<CreateAgeRangeInput>;
};
...
export type Organization = {
  ...
  /** @deprecated Sunset Date: 30/08/2022 Details: https://calmisland.atlassian.net/l/c/8d8mpL0Q */
