...
export type UserIdNameFragment = { __typename?: "User" } & Pick<Types.User, "user_id" | "user_name" | "family_name" | "given_name">;
...
export type GetUsersByNameQuery = { __typename?: "Query" } & {
  usersConnection?: Types.Maybe<
    { __typename?: "UsersConnectionResponse" } & {
      edges?: Types.Maybe<
        Array<
...
export type GetProgramIdByNameQuery = { __typename?: "Query" } & {
  programsConnection?: Types.Maybe<
                          ...
                          Array<
                            Types.Maybe<
                              { __typename?: "SubjectsConnectionEdge" } & {
                                node?: Types.Maybe<
                                  { __typename?: "SubjectConnectionNode" } & Pick<
                                    Types.SubjectConnectionNode,
                                    "id" | "name" | "status" | "system"
                                  >
                                >;
                              }
                          ...
                          Array<
                            Types.Maybe<
                              { __typename?: "GradesConnectionEdge" } & {
                                node?: Types.Maybe<
                                  { __typename?: "GradeConnectionNode" } & Pick<
                                    Types.GradeConnectionNode,
                                    "id" | "name" | "status" | "system"
                                  >
                                >;
                              }
...
export type GetClassesListQueryVariables = Types.Exact<{
  organization_id: Types.Scalars["ID"];
}>;

export type GetClassesListQuery = { __typename?: "Query" } & {
  organization?: Types.Maybe<
    { __typename?: "Organization" } & {
      classes?: Types.Maybe<
        Array<
 ...
 * });
 */
export function useGetProgramIdByNameQuery(
  baseOptions: Apollo.QueryHookOptions<GetProgramIdByNameQuery, GetProgramIdByNameQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetProgramIdByNameQuery, GetProgramIdByNameQueryVariables>(GetProgramIdByNameDocument, options);
}
export function useGetProgramIdByNameLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetProgramIdByNameQuery, GetProgramIdByNameQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type GetProgramIdByNameQueryResult = Apollo.QueryResult<GetProgramIdByNameQuery, GetProgramIdByNameQueryVariables>;
export const GetClassesListDocument = gql`
  query getClassesList($organization_id: ID!) {
    organization(organization_id: $organization_id) {
      classes {
        class_id
        class_name
...
/**
 * __useGetClassesListQuery__
 *
 * To run a query within a React component, call `useGetClassesListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClassesListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClassesListQuery({
 *   variables: {
 *      organization_id: // value for 'organization_id'
 *   },
 * });
 */
export function useGetClassesListQuery(baseOptions: Apollo.QueryHookOptions<GetClassesListQuery, GetClassesListQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetClassesListQuery, GetClassesListQueryVariables>(GetClassesListDocument, options);
}
export function useGetClassesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClassesListQuery, GetClassesListQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetClassesListQuery, GetClassesListQueryVariables>(GetClassesListDocument, options);
}
export type GetClassesListQueryHookResult = ReturnType<typeof useGetClassesListQuery>;
export type GetClassesListLazyQueryHookResult = ReturnType<typeof useGetClassesListLazyQuery>;
export type GetClassesListQueryResult = Apollo.QueryResult<GetClassesListQuery, GetClassesListQueryVariables>;
